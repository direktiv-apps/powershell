...
//go:generate swagger generate server --target ../../app --name Powershell --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/powershell/build/templates --principal interface{}

func configureFlags(api *operations.PowershellAPI) {
...
func configureAPI(api *operations.PowershellAPI) http.Handler {
